...
public class FenetreConfirmerCreation extends FenetreContextuelle {

private Stock stock1;
private Produit p;

//Constructeur
	public FenetreConfirmerCreation(Produit p, Stock stock1) {
	super();
	this.stock1 = stock1;
	this.p=p;
	initUI();
	...
	public void initUI() {
		...
		add(panel1);
		label1 = new JLabel("Le produit a été créé. Voulez-vous enregistrer ?");
